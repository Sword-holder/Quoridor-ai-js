    ...
    function simulation(wallSimulations,moveSimulations) {
        ...
        arrShortestMoves_b[1]-arrShortestMoves_b[0]<=-2) {   
            ...
            if (fromLoc==-1) {
                ...
                if (nextLoc==-1) {
                    nextLoc = wallSimulations.indexOf(compLoc-7+"-"+compLoc); 
            ...
            for (var t=finalLocToCheck+35;t>finalLocToCheck-35;t--) {  
                if (wallPreventTrap==null && typeof wallSimulations[t]!='undefined') {  
                    ...
                    if (whatWallPlace_0=="wallPlacementHoriz") {  
                        var test_wall_1 = wallSimulations[t];
                        var test_wall_2 = $('#board td[data-pos='+(test_wall_1)+']').next().next().attr('data-pos');  
                        var checkLegal = placeHorizWall_COMPUTE(test_wall_1,noWalls_td,walls_td,8,8,playerLoc,oppLoc,'c'); 
                    } else if (whatWallPlace_0=="wallPlacementVert") {  
                        var test_wall_1 = wallSimulations[t];
                        var nvf = parseInt(test_wall_1.substr(0,test_wall_1.indexOf("-"))) + boardWidth;
                        var nvs = parseInt(test_wall_1.substr(test_wall_1.indexOf("-")+1)) + boardWidth;
                        var test_wall_2 = nvf+"-"+nvs;      
                        var checkLegal = placeVertWall_COMPUTE(test_wall_1,noWalls_td,walls_td,8,8,playerLoc,oppLoc,'c');     
                    }           
                        ...
                        for (var a=finalLocToCheck+35;a>finalLocToCheck-35;a--) {   
                            if (test_wall_1!=wallSimulations[a] && test_wall_2!=wallSimulations[a] && wallPreventTrap==null &&
                                ...
                                if (whatWallPlace_2=="wallPlacementHoriz") {
                                    ...
                                    var checkLegal_2 = placeHorizWall_COMPUTE(test_wall_1_1,checkLegal[0].join(",").split(","),checkLegal[1],8,8,playerLoc,oppLoc,'c'); 
                                }
                                    ...
                                    var checkLegal_2 = placeVertWall_COMPUTE(test_wall_1_1,checkLegal[0].join(",").split(","),checkLegal[1],8,8,playerLoc,oppLoc,'c');    
                                }                   
                                        ...
                                        for (var b=finalLocToCheck-90;b<finalLocToCheck+10;b++) {  
                                            ...
                                            test_wall_1_1!=wallSimulations[b] && test_wall_2_2!=wallSimulations[b] && typeof wallSimulations[b]!='undefined') {  
                                                ...
                                                if (whatWallPlace_3=="wallPlacementHoriz") {  
                                                    ...
                                                    var checkLegal_3 = placeHorizWall_COMPUTE(test_wall_1_b,checkLegal_2[0].join(",").split(","),checkLegal_2[1]+","+test_wall_1_1+","+test_wall_2_2,8,8,playerLoc,oppLoc,'c');
                                                    ...
                                                    var checkLegal_3 = placeVertWall_COMPUTE(test_wall_1_b,checkLegal_2[0].join(",").split(","),checkLegal_2[1]+","+test_wall_1_1+","+test_wall_2_2,8,8,playerLoc,oppLoc,'c');   
                                                }
        ...
        if (fromLoc==-1) {
            ...
            if (nextLoc==-1) {
                nextLoc = wallSimulations.indexOf(playerLoc-7+"-"+playerLoc); 
                if (nextLoc==-1) {  
                    nextLoc = wallSimulations.indexOf(playerLoc+"-"+playerLoc+7);
                    if (nextLoc==-1) {
            ...
            for (var t=finalLocToCheck-25;t<finalLocToCheck+25;t++) {  
                ...
                arrShortestMoves_b[1]-arrShortestMoves_b[0]>=2) {     
                    ...
                    if (whatWallPlace=="wallPlacementHoriz") {  
                        var test_wall_1 = wallSimulations[t];
                        var test_wall_2 = $('#board td[data-pos='+(test_wall_1)+']').next().next().attr('data-pos');
                        var checkLegal = placeHorizWall_COMPUTE(test_wall_1,noWalls_d,walls_d,8,8,playerLoc,oppLoc,'c');     
                    } else if (whatWallPlace=="wallPlacementVert") {  
                        var test_wall_1 = wallSimulations[t];
                        var nvf = parseInt(test_wall_1.substr(0,test_wall_1.indexOf("-"))) + boardWidth;
                        var nvs = parseInt(test_wall_1.substr(test_wall_1.indexOf("-")+1)) + boardWidth;
                        var test_wall_2 = nvf+"-"+nvs;        
                        var checkLegal = placeVertWall_COMPUTE(test_wall_1,noWalls_d,walls_d,8,8,playerLoc,oppLoc,'c');   
                    }
